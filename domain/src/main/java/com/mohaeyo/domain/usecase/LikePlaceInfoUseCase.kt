...
class LikePlaceInfoUseCase(
    private val placeService: PlaceService,
    composite: CompositeDisposable): UseCase<Pair<PlaceEntity, ErrorHandlerEntity>, String>(composite) {
    override fun createFlowable(location: String): Flowable<Pair<PlaceEntity, ErrorHandlerEntity>>
            = placeService.postLikePlace(location)
}